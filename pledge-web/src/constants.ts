...
export const MOCK_GRAPH_NODES: GraphNode[] = [
    { id: 'u-me', label: 'Me', strength: 1, statusMix: { verified: 3, pending: 1, unclear: 1 }, lastInteraction: '2023-10-15', topTags: ['mentorship'] },
    { id: 'u-1', label: 'Alice', strength: 0.8, statusMix: { verified: 2, pending: 0, unclear: 0 }, lastInteraction: '2023-10-05', topTags: ['career'] },
    { id: 'u-2', label: 'Bob', strength: 0.4, statusMix: { verified: 0, pending: 1, unclear: 0 }, lastInteraction: '2023-10-10', topTags: ['moving'] },
    { id: 'u-3', label: 'Charlie', strength: 0.6, statusMix: { verified: 1, pending: 0, unclear: 0 }, lastInteraction: '2023-10-12', topTags: ['code'] },
    { id: 'u-4', label: 'David', strength: 0.2, statusMix: { verified: 0, pending: 0, unclear: 1 }, lastInteraction: '2023-10-15', topTags: ['donation'] },
];

export const MOCK_GRAPH_LINKS: GraphLink[] = [
    { source: 'u-me', target: 'u-1', verifiedCount: 1, pendingCount: 0, unclearCount: 0, strength: 1 },
    { source: 'u-1', target: 'u-me', verifiedCount: 1, pendingCount: 0, unclearCount: 0, strength: 1 },
    { source: 'u-me', target: 'u-2', verifiedCount: 0, pendingCount: 1, unclearCount: 0, strength: 0.5 },
    { source: 'u-3', target: 'u-me', verifiedCount: 1, pendingCount: 0, unclearCount: 0, strength: 0.8 },
    { source: 'u-me', target: 'u-4', verifiedCount: 0, pendingCount: 0, unclearCount: 1, strength: 0.3 },
];
